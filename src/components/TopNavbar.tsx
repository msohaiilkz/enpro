        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="hidden sm:inline-flex items-center gap-2 bg-[#bf1e2e] hover:bg-[#a61625] text-white font-semibold px-5 py-2.5 rounded-xl text-[13px] transition-all duration-200 hover:shadow-lg hover:shadow-[#bf1e2e]/30 whitespace-nowrap group"
            >
              GET A QUOTE
