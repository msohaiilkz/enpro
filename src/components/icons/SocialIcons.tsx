/**
 * Official brand glyphs, solid style.
 *
 * lucide-react's social icons are thin outlines (and its brand set is
 * deprecated), which clashed with the solid WhatsApp mark. Keeping all three as
 * proper filled brand marks makes the row read as one set.
 */
